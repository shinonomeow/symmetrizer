import numpy as np
from my_s.ops import GroupRepresentations
...
class MatrixRepresentation(Group):
    ...
    def __init__(
        self,
        input_matrices: GroupRepresentations,
        output_matrices: GroupRepresentations,
    ):
        """ """
        self.repr_size_in: int = input_matrices[0].shape[1]  # 4x4 所以是 4
        self.repr_size_out: int = output_matrices[0].shape[1]  # 2x2 所以是 2
    ...
    def _input_transformation(self, weights, params:int):
        """
